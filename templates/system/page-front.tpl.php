...
<body class="<?php print $body_classes; ?>">
      ...
      <div id="navigation" class="menu top-nav <?php if (!empty($primary_links)) { print "withprimary"; } if (!empty($secondary_links)) { print " withsecondary"; } ?> ">
        <?php if (!empty($primary_links)): ?>
          <div id="primary" class="clear-block">
            ...
            <!--<div class="addthis_horizontal_follow_toolbox pull-left hidden-xs"></div>-->
  ...
  <div id="page" class="test home-page">
	<div class="container">
  ...
  <div id="content-bottom" class="fluid content-bottom">
              <div class="container">
                    <div class="row">
  ...
  <div class="front-services clearfix">
	<div class="services-box core-services col-sm-6">
        ...
        <a href="/our-services/core-services" class="position-ab text-alin border-round">Core Services</a>
    </div><!-- Core Services End -->
    
    <div class="services-box specialist-services col-sm-6">
    	<img src="<?php print base_path().path_to_theme();?>/images/specialist.jpg" alt="">
        <a href="/our-services/specialist-services" class="position-ab text-alin border-round">Specialist Services</a>
    </div><!-- Specialist Services End -->
    
  </div><!-- Front Services End -->
  
  <?php if($front_news){
		print '<div class="front-news"><div class="container"><div class="row">';
      		print $front_news;
    	print '</div></div></div>';
  } ?>

  <?php if($front_team){
		print '<div class="front-team">';
      		print $front_team;
    	print '</div>';
  } ?>
  
  <?php if($front_affiliates){
		print '<div class="front-affiliates"><div class="container"><div class="row">';
      		print $front_affiliates;
    	print '</div></div></div>';
  } ?>
