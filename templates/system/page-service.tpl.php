 ...
 */
  $free_consultation_title = $node->field_free_consultation_title[0]['value'];
  $free_consultation_content = $node->field_free_consultation_content[0]['value'];
?>
    ...
    <div id="container" class="clear-block">
      ...
      <div id="main" class="column"><div id="main-squeeze">
		...
		<?php if ($node->field_testimonial[0][nid] != NULL): ?>
          <div class="row">
          <div class="related-testimonial col-xs-12 ">
                <?php if ($node->field_testimonial[0][nid]): ?>
                    <?php print views_embed_view('testimonial_view','block_1',$node->field_testimonial[0][nid]); ?>
                <?php endif; ?>
          </div>
          </div>
		<?php endif; ?>
      ...
      <?php if (!empty($right)): ?>
        <div id="sidebar-right" class="column sidebar">
          <?php print $right; ?>
		  <?php if ($node->field_staff_profile_expert[0][nid] != NULL): ?>
			<div class="row">
			<div class="related-staff col-xs-12 ">
				  <?php if ($node->field_staff_profile_expert[0][nid]): ?>
					  <?php print views_embed_view('staff_profile_expert_view','block_1',$node->field_staff_profile_expert[0][nid]); ?>
				  <?php endif; ?>
			</div>
			</div>
		  <?php endif; ?>
		  <?php if ($free_consultation_title) {
			print '<div class="free-consultation more-btn">';
			  print '<h2 class="consultation-title">';
				print $free_consultation_title;
			  print '</h2>';
			  print '<div class="consultation-content">';
				print $free_consultation_content;
			  print '</div>';
			  print '<p class="consultation-link"><a href="/contact">Book your appointment</a></p>';
			print '</div>';
		  } ?>
        </div> <!-- /sidebar-right -->
      <?php endif; ?>
